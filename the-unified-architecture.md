...
Emoji: "\U0001F4A1"
id: bafyreihkalohylof3a4m4abxu43bgx7wu4v2advq7qwxmgfkrkdbw3hnha
---
# The Unified Architecture   
A multi-view atlas of the [Third Intelligence](third-intelligence.md) system: a routing map that relates complementary architectural lenses and points to the specialized objects that carry each view. Not an encyclopedia but a navigation instrument.   
...
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
|                                                                                                                                                                                                                         AI is held as DTO — No subject drift, no epistemic authority collapse |       [Dynamic Transitional Object](dynamic-transitional-object-dto.md), [Iron Man Mentality](iron-man-mentality.md) |
|                                                                                                                                                                                    Sₑ ⊗ Sₜ are non-substitutable — Technical scaffolding cannot compensate for depleted emotional scaffolding |                                                                  [Field Viability Schema](field-viability-schema.md) |
...
|                               Two-Layer Complementarity — [Winnicott](d-w-winnicott.md) describes conditions under which experience becomes ACCESSIBLE; Third Intelligence describes architecture within which accessible experience becomes TRANSFORMED. Sequential and mutually completing. | [Psychoanalytic Prerequisites](psychoanalytic-prerequisites.md), [Developmental Sequence](developmental-sequence.md) |
...
|             Component |                                                            Function |
|:----------------------|:--------------------------------------------------------------------|
|     [Human](human.md) |            Container (Sₑ), Alpha-Function, authorship, verification |
| [Journal](journal.md) |       Chronotope, materialization, cross-temporal pattern substrate |
|           [AI](ai.md) |   Sₜ, Functional Alterity, constraint-generation (when held as DTO) |
|       [Time](time.md) |                               Recovery, consolidation, accumulation |
...
|     3 |  Recursive Process |                                  [Alpha-Function](alpha-function.md) via C1 ↔ C2 coupling |
|     4 |       Accumulation |   [Materialization](materialization.md) + Time → durable [Capacity](c-capacity.md) growth |

The Mechanism (Levels 3–4):   
The [Recursive Metabolic Loop](recursive-metabolic-loop.md) (RML) is the engine of development: unresolved material enters → metabolic processing (Alpha-Function via C1 ↔ C2) → crystallization (owned insight stabilizes) → materialization (inscription in a durable substrate) → re-entry as a new capacity baseline.   
...
- [Identity stakes](identity-stakes.md) → Journal entry   
...
Routes to →   
- To understand: Field Viability Schema, [Integrated Circuit Board](the-integrated-circuit-board.md), Recursive Metabolic Loop, Alpha-Function   
- To act: [Touch Grass Protocol](touch-grass-protocol.md) (when Level 2 fails), [4Ps Protocol](4ps-protocol.md) (Level 3 verification), Coherence Flywheel (self-diagnosis: "where am I in the cycle?")   
...
|  B (Metabolic) | Whether Alpha operates | Metabolization active | [PSB](protein-shake-brain-psb.md) / Overwhelm |

Routes to →   
- To understand: [Two-Axis Framework](two-axis-framework.md), Category Error, PSB, [Cognitive Dependency](cognitive-dependency.md)   
- To act: [Touch Grass Protocol](touch-grass-protocol.md) (Axis A or B collapse), Iron Man Mentality (Axis A maintenance)   
...
|:------|:----------------|:------------------------------------------------|:--------------------------------------------|
| Micro |   Per-utterance |   [Functional Alterity](functional-alterity.md) | Turn-by-turn difference, productive tension |
|  Meso | Per-interaction | [Functional Thirdness](functional-thirdness.md) |         Session-level dialogical legitimacy |
...
|:--------------------------------------------------------------|:----------------------------------------------------|
|     [Holding Environment ](holding-environment.md)(Winnicott) |                                        Sₑ viability |
| [Alpha-Function](alpha-function.md) ([Bion](wilfred-bion.md)) |                                  Metabolic capacity |
| [Protected Self-Holding](protected-self-holding-principle.md) |   Post-interpersonal Sₑ preservation in AI contexts |
...
Routes to →   
- To understand: [Developmental Sequence](developmental-sequence.md), [Psychoanalytic Prerequisites](psychoanalytic-prerequisites.md), Protected Self-Holding Principle, [Activation Conditions](activation-conditions.md)   
...
The [Coherence Flywheel](coherence-flywheel.md) provides phenomenological markers for the Recursive Metabolic Loop (RML):   
...
Routes to → Theorist objects (Winnicott, Bion, [Gendlin](eugene-gendlin.md), [Bollas](christopher-bollas.md)), Coherence Flywheel   
...
|:----------------------------|:----------------------------------------------------------------|
|                Sₑ / Holding |                              [HPA-Axis](hpa-axis.md) regulation |
|              Alpha-Function |  [Triple Network Model](triple-network-model.md) (DMN, FPN, SN) |
| [Felt Sense](felt-sense.md) | [Anterior Insular Cortex (AIC)](anterior-insular-cortex-aic.md) |
