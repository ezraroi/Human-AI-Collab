...
| Component |                                                                                             Function |
|:----------|:-----------------------------------------------------------------------------------------------------|
|     Human |    [Container](the-container.md) (Sₑ), [Alpha-Function](alpha-function.md), authorship, verification |
|   Journal | [Chronotope](chronotope.md), [materialization](materialization.md), cross-temporal pattern substrate |
|        AI |          Sₜ, [Functional Alterity](functional-alterity.md), constraint-generation (when held as DTO) |
...
|:------|:-------------------|:--------------------------------------------------------------------|
|     1 | Relational Posture | DTO stance, [epistemological humility](epistemological-humility.md) |
...
|:--------------------------------------------------------------|:----------------------------------------------------|
|           Holding Environment ([Winnicott](d-w-winnicott.md)) |                                        Sₑ viability |
|                      Alpha-Function ([Bion](wilfred-bion.md)) |                                  Metabolic capacity |
...
|:---------------|:----------------------------------------------------------------|
|     Stages 1–6 |   [Holding Environment](holding-environment.md) (Sₑ stabilizes) |
...
|:-------------|:--------------------------------|:----------------------------------------------------|
|   Foundation |   [Winnicott](d-w-winnicott.md) |           Ontological security, continuity-of-being |
|   Processing |         [Bion](wilfred-bion.md) |     β → α transformation, thinking becomes possible |
| Verification |    [Gendlin](eugene-gendlin.md) |       "Spacious vs. tight" — embodied truth-testing |
|   Expression | [Bollas](christopher-bollas.md) |                 "This is mine" — idiom articulation |
...
|      Felt Sense | [Anterior Insular Cortex (AIC)](anterior-insular-cortex-aic.md) |
