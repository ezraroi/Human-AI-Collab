...
I proposed a refinement: S = [S\_e](emotional-scaffolding-s_e.md) \* [S\_t](technical-scaffolding-s_t.md), where S\_e is Emotional Scaffolding (Safety/Trust) and [S\_t](technical-scaffolding-s_t.md) is Technical Scaffolding (Guidance).   
...
- [Winnicott](d-w-winnicott.md): [S\_e](emotional-scaffolding-s_e.md) is the "[holding environment](holding-environment.md)". Without it, the [True Self ](true-self.md)cannot emerge.   
...
This final formula explains the "brilliant but toxic" leader. They have high [S\_t](technical-scaffolding-s_t.md) (technical skill) but [S\_e](emotional-scaffolding-s_e.md) is zero. Because the relationship is multiplicative, the numerator (0 * [S\_t](technical-scaffolding-s_t.md)) becomes zero, the whole function fails, and no growth occurs. Safety is a non-negotiable prerequisite for growth.*    
