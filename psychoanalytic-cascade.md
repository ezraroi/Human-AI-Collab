...
---
# Psychoanalytic Cascade   
The sequential integration of the three theorists ([Wilfred Bion](wilfred-bion.md) , [D.W. Winnicott](d-w-winnicott.md)  and [Christopher Bollas](christopher-bollas.md) ).   
...
1. **FOUNDATION: [The Holding Environment](holding-environment.md)** (Winnicott)   
...
2. **MECHANISM: [The Alpha-Function](alpha-function.md)** (Bion)   
...
3. **MOTIVE: The [Destiny Drive](destiny-drive.md)**[ ](destiny-drive.md)(Bollas)   
