...
---
# As-If Body Loop   
A hypothesized mechanism by which symbolic input ([Channel 2](channel-2-symbolic.md)) can recruit embodied simulation ([Channel 1](channel-1-embodied-sensorimotor-pathway.md)), supporting the availability of [Felt Sense](felt-sense.md) as a Channel 1 verification signal without requiring overt physical change.   
