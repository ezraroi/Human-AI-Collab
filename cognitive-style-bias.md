...
**Relations (Wiring):**   
- **Dependency On:** [Human](human.md) (cognitive capacities)   
- **Limitation Of:** [Third Intelligence](third-intelligence.md) (unknown applicability)   
...
**Notes:**   
**Sharpest methodological question facing research.** Single-case design ([HSCED](hsced-hermeneutic-single-case-efficacy-design.md)) enables rigorous idiographic conclusions but inherently cannot answer population-level generalizability. Status: "We know it worked for one cognitively sophisticated systems-thinker—completely unknown if it works for others."   
