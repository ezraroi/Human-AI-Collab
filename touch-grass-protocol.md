...
A **withdrawal + return-to-baseline protocol** that ends (or pauses) AI-dialogue when **[Emotional Scaffolding](emotional-scaffolding-s_e.md) depletion markers** appear, in order to restore metabolic capacity and re-anchor validation in lived reality (A→B→A logic).   
**System Role**   
