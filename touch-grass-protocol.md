...
Creation date: "2025-12-19T12:20:36Z"
Created by:
    - Roi Ezra
Links:
    - emotional-scaffolding-s_e.md
...
**System Role**   
- **Recovery Architecture:** restores [Emotional Scaffolding](emotional-scaffolding-s_e.md) via spacing (within-session + between-session).   
...
- **Relational Re-grounding (preferred):** re-enters real interpersonal space to prevent the [AI](ai.md) from being recruited as holding substitute during Sₑ depletion, and to recalibrate the Subject/Object distinction experientially—not just conceptually.   
...
- A cleaner next session (less [PSB](protein-shake-brain-psb.md) risk, better [Alpha-Function](alpha-function.md) availability)   
- A natural test of which insights persist outside the dialogic field   
- **Recalibrated Subject/Object distinction** (what real Subjects feel like vs. [DTO](dynamic-transitional-object-dto.md))   
...
**Relations (Wiring)**   
- **Depends On:** [Metacognition](metacognition.md) (monitoring + regulation)   
