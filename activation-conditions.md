...
Creation date: "2025-12-24T12:25:30Z"
Created by:
    - Roi Ezra
Links:
...
Emoji: "\U0001F4A1"
id: bafyreigxilpmcfmarsc4fn7y6epifyg32lhyswwidahkpbaunnnxjkakni
---
# Activation Conditions   
The structured specification of **who can reliably activate** the [Third Intelligence](third-intelligence.md) mechanism, and **under what conditions**. Activation Conditions defines the accessibility layer over the [Two-Axis Framework](two-axis-framework.md): it specifies whether the Two-Axis plane can be stably occupied at all, and what scaffolds are required to prevent drift.   
This concept answers: "Given a specific user, can they safely and effectively engage [identity-stakes](identity-stakes.md) AI dialogue?"   
...
- Failure attractors ([Category Error](category-error.md), [PSB](protein-shake-brain-psb.md)) become sticky   
...
- Internalized holding capacity ([Winnicott](d-w-winnicott.md)'s "capacity to be alone")   
- Self-holding durability during [identity-stakes](identity-stakes.md) work   
- [Emotional Scaffolding](emotional-scaffolding-s_e.md) viability sufficient for the [Human](human.md) to remain Container   
...
- Maps directly to Viability Envelope in [Field Viability Schema](field-viability-schema.md)   
...
*Illustrative markers (not diagnostic; see [Readiness Probes](readiness-probes.md) for operational detection):*   
...
The behavioral capacity to maintain viable quadrant position in the [Two-Axis Framework](two-axis-framework.md):   
...
**Properties:**   
- May be trainable or inducible via procedural scaffolding (e.g., [Cognitive Mirror](cognitive-mirror-protege-mode.md))   
- Only scaffoldable when Layer 1 is viable   
- Supports Axis A maintenance ([DTO](dynamic-transitional-object-dto.md) stance) and Axis B maintenance (metabolic oscillation)   
...
**Operationally:** Layer 2 is maintained through [RPVL](recursive-pattern-verification-loop.md) (continuous verification posture across dialogue) and enforced at uptake moments by the [4Ps Protocol](4ps-protocol.md) (Pause/Probe/Process/Possess as the local acceptance gate).   
...
This boundary is ethical in intent and methodological in enforcement (operationalized via Readiness Probes + stop/withdrawal protocols)**.** Detection and routing are operationalized in [Readiness Probes](readiness-probes.md).   
### Relations (Wiring)   
**Architectural Position:**   
- **Gates Entry To:** [Two-Axis Framework](two-axis-framework.md); [Field Viability Schema](field-viability-schema.md)   
- **Assessed By:** [Readiness Probes](readiness-probes.md)   
- **Scaffolded By:** [Cognitive Mirror](cognitive-mirror-protege-mode.md) (Layer 2, Zone B)   
   
**Layer Mappings:**   
- **Layer 1 → :** Viability Envelope; [Holding Environment](holding-environment.md); [Protected Self-Holding Principle](protected-self-holding-principle.md)   
- **Layer 2** → : Axis A + B maintenance; RPVL (continuous verification); [4Ps Protocol](4ps-protocol.md) (local acceptance gate); [Epistemological Humility](epistemological-humility.md)   
   
**Constrained By:** Protected Self-Holding Principle
**Failure Attractors (when violated):** Category Error; PSB; [Cognitive Dependency](cognitive-dependency.md); Simulated Holding Environment   
### Notes   
