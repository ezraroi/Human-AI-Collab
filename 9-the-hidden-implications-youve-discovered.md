...
NoteBook 2 shows that words are not separate from body — they activate embodied simulation. This explains why [Vygotsky](lev-vygotsky.md)’s “symbolic tools” still engage the embodied channel ([Channel 1](channel-1-embodied-sensorimotor-pathway.md)).   
...
- [Beta-elements](beta-elements.md) (raw, unprocessed felt experience)   
- Become [journal](journal.md)-captured alpha-elements (thinkable thoughts / inscribed meaning)   
...
Phenomenological markers of [alpha-function](alpha-function.md) activation:   
