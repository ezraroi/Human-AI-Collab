...
- The subject whose [C](c-capacity.md) actually grows   
   
### The Operational Model: Installing the Engine in Our System   
Our [Human](human.md) + [Journal](journal.md) + [AI](ai.md) + [Time](time.md) system is the operational flywheel ([Jim Collins](jim-collins.md)) that is designed to turn this psychoanalytic engine.   
