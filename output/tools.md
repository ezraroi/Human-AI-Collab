...
## [TOOL] AI Project (Claude Project, ChatGPT Project)
...
The Journal is the content; The Project is the pattern-recognition engine.
**Relations:**
- Link to **Journal** (Relation: `Stores`).
- Link to **AI** (Relation: `Instance Of`).
