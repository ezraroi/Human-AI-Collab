...
### System Role   
RPVL is the **core anti-collapse mechanism** running throughout all phases of [Reflective Prompting](reflective-prompting.md), maintaining epistemic integrity while work is live.   
**[Two-Axis](two-axis-framework.md) positioning**   
...
- Prevents **[Channel-2](channel-2-symbolic.md)-only adoption** ([PSB](protein-shake-brain-psb.md) pathway).   
...
### [Protected Self-Holding](protected-self-holding-principle.md) (Connection)   
...
### Relations (Wiring)   
- **[Reflective Prompting](reflective-prompting.md) — Part Of** (runs throughout all phases)   
- **[4Ps Protocol](4ps-protocol.md) — Contains / Triggers** (local gate within RPVL at uptake moments)   
- **[Two-Axis Framework](two-axis-framework.md) — Stabilizes** (reduces drift on Axis A and Axis B)   
- **[Protected Self-Holding](protected-self-holding-principle.md) — Operationalizes** (human remains verifier/container)   
- **[Iron Man Mentality](iron-man-mentality.md) — Operationalizes** (verification + authorship posture)   
- **[Felt Sense](felt-sense.md) — Relies On** (primary embodied verification signal)   
