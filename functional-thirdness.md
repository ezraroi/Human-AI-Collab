...
### Gating Condition   
**DTO Stance** — FT can only operate when [AI](ai.md) is held as Dynamic Transitional Object.   
...
- Preserves the productivity of the pre-existing [Challenge Gap](challenge-gap-d-c.md) (\|D–C\|)   
...
**3. [Human](human.md) Agency (Maintained Authorship)**   
...
**[Productive Epistemic Tension](productive-epistemic-tension.md)** — The felt state of being cognitively stretched but still able to think.   
...
- **Destroyed By → **[Category Error](category-error.md), Sycophancy, S\_e depletion, Agency collapse   
...
Recovery requires restoring [DTO](dynamic-transitional-object-dto.md) stance + re-engaging metabolic processing + Sₑ restoration (often via [Touch Grass Protocol](touch-grass-protocol.md))   
