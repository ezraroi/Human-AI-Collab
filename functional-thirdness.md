...
- Not dependent on [Journal](journal.md) or [Time](time.md) (those belong to the Tetrad’s diachronic architecture)   
- Not something the AI “does” or “performs”   
   
### System Role   
FT serves three functions within the [Third Intelligence](third-intelligence.md) architecture:   
...
Viable [Field](field-viability-schema.md) — sufficient Sₑ ([emotional scaffolding](emotional-scaffolding-s_e.md)) for metabolization.
...
- Gated By → [DTO](dynamic-transitional-object-dto.md) stance (precondition)   
...
- Constituted By → [Functional Alterity](functional-alterity.md) + [Systematic Competence](systematic-competence.md) + Human Agency   
- Human Agency Grounded In → [Protected Self-Holding Principle](protected-self-holding-principle.md)   
- Human Agency Maintained By → [RPVL](recursive-pattern-verification-loop.md) (continuous verification posture)   
