...
This object describes **input-side gating** for the [Integrated Circuit Board](the-integrated-circuit-board.md):   
...
- **Failure Mode (when absent):** [PSB](protein-shake-brain-psb.md), [Cognitive Dependency](cognitive-dependency.md)   
- **Distinct From:**   
