...
- [Channel 1](channel-1-embodied-sensorimotor-pathway.md) (embodied sensorimotor/interoceptive) provides verification   
- [Channel 2](channel-2-symbolic.md) (symbolic) provides articulation   
- Integration is the output of [Alpha-Function](alpha-function.md) cycles   
- Materialization ([journal](journal.md)) makes it stable   
...
- [AI](ai.md): provides symbolic challenge in Channel 2 that initializes productive tension   
- [Time](time.md): allows recursive strengthening   
