...
Links:
    ...
    - journal.md
    - time.md
id: bafyreigxhqak73htscwlribi4pc34j22gqijmdr45zxfkyin2jmzaqls4q
---
# Section 3 — Causal Sequence Placement   
This notebook locates [Selected Fact](selected-fact.md) within a causal sequence that distinguishes raw experience, metabolic processing, and coherent knowing. The essential ordering, as adopted for this research, is:   
[beta-elements](beta-elements.md) (raw, unprocessed material)
→ conditions for digestion (containment and tolerable not-knowing)
→ [alpha-function](alpha-function.md) activity (metabolization into thinkable form)
→ [alpha-elements](alpha-elements.md) (processed material)
