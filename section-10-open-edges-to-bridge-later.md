...
Links:
    ...
    - alpha-function.md
id: bafyreiaicajxcr3dj3us4wj4ced23vp225ist3cwrymn5leyl4wfmgnwzi
---
...
**Bridging needed:**   
- Developmental accounts of writing as higher psychological function ([Vygotsky](lev-vygotsky.md): externalization that reorganizes cognition vs. externalization that merely records it)   
...
The notebook strongly implies that Selected Fact formation requires a posture of tolerable not-knowing ([Negative Capability](negative-capability.md) / faith) and that counterfeits arise through premature certainty. The [Iron Man Mentality](iron-man-mentality.md) Object already contains the posture definition, protocol-level mechanisms, and operational markers. What remains is to formalize the explicit mapping to Negative Capability in a reusable, protocol-level form.   
