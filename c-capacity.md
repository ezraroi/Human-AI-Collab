...
---
# C (Capacity)   
The user's current psychic structure, cognitive skills, and accumulated store of processed [alpha-elements](alpha-elements.md) (metabolized insights). C represents the **developmental substrate** that actually grows through transformation—the variable measuring what the [Human](human.md) has become capable of.   
**Formula Role:**   
...
**Relations (Wiring):**   
- **Component Of:** [P(α)](p-alpha-probability-of-growth.md) formula (denominator, paired with D)   
...
- [D](d-difficulty.md) provides challenge   
- \|D-C\| creates tension   
