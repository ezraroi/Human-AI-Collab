...
- Enables **diagnosis of distinct failure modes**:   
    - [PSB](protein-shake-brain-psb.md) (C1 ↔ C2 coupling systematically absent)   
    - Symbolic Overrun (As-If Body Loop weak or offline)   
    - Transient Insight ([Journal](journal.md) missing when durable growth needed)   
...
|:-------------------------------------|:---------------------------------------------------------|:---------------------------------------------------------|:------------------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| **Full Metabolic Pass (Full Click)** |                           C1 ↔ C2 oscillation stabilizes |                                   Discrete owned insight |                                   Yes — captures what became true |                              Durable C growth via stored [alpha-element](alpha-elements.md) |
...
- **If the Journal is missing when durable growth is needed:**   
    ...
    - Future \|[D–C](challenge-gap-d-c.md)\| gaps become miscalibrated.   
...
- **Contributes To:**   
    ...
    - Prevention / diagnosis of [PSB](protein-shake-brain-psb.md), Symbolic Overrun, Transient Insight   
