...
- **Goal:** [Recursive Metabolic](recursive-metabolic-loop.md) Oscillation (C2 ↔ C1 ↔ Alpha).   
...
If Axis A fails ([Category Error](category-error.md)), the entire circuit board is **bypassed**: AI becomes Subject, \|D−C\| collapses, [PSB](protein-shake-brain-psb.md) / dependency flood in.   
### Wiring (Relations)   
- **Maps:**   
    - Category Error   
