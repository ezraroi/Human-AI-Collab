...
1. **Non-Substitutability of Scaffolds ([Emotional Scaffolding](emotional-scaffolding-s_e.md) ⊗ [Technical Scaffolding](technical-scaffolding-s_t.md))**   
...
Scaffolding is meaningful only relative to the challenge gap. Different [challenge gap](challenge-gap-d-c.md)s (size and type) require different levels and kinds of scaffolding.   
- [D](d-difficulty.md) is multidimensional: cognitive complexity, affect load, identity stakes, novelty   
...
**3. Workable Range ([ZPD](zpd.md) Window)**   
Experienced mismatch must remain within a workable range—neither bypassed nor unbridgeable.   
- Gap bypassed → [PSB](protein-shake-brain-psb.md) (no pressure to metabolize)   
...
|                      **Enables** |                                                                                                                                      [Alpha-Function](alpha-function.md) activation |                           When field viability holds |
