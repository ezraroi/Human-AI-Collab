...
- **Metabolization discriminator**: no validated physiological/neural markers distinguishing:   
    - embodied integration (“[felt shift](felt-shift.md)” + regulation restoration),   
...
- **Modeled By:** [Triple Network](triple-network-model.md) dynamics; Interoceptive inference; Stress regulation physiology; Consolidation models   
...
- **Maps:** [Alpha-Function](alpha-function.md); [Felt Sense](felt-sense.md); Sₑ/[Container](the-container.md); [Journal](journal.md)+[Time](time.md); [Category Error](category-error.md) boundary states   
