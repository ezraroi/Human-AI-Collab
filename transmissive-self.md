...
---
# Transmissive Self   
A self-state articulated by [Christopher Bollas](christopher-bollas.md) where the person is no longer generating meaning but **transmitting** externally provided fluency—unearned and unintegrated. The Transmissive Self **can articulate but cannot author**; it speaks eloquently but without ownership.   
...
**Digital-era positioning:** The Transmissive Self is the **[False Self](false-self.md) of the digital era** ([Winnicott](d-w-winnicott.md))—a compliant, adaptive shell that has lost contact with the spontaneous, creative True Self. It is the psychic configuration **demanded by epistemic ecologies organized around Basic-Assumption Dependency (BaD)**.   
### System Role   
The Transmissive Self is a **downstream consequence** of sustained [PSB](protein-shake-brain-psb.md). It represents the consolidation of processing bypass into a stable self-structure. Where PSB is an episodic failure mode, Transmissive Self is the **characterological outcome** when bypass becomes habitual.   
...
1. **Sustained PSB:** Repeated [Channel 2](channel-2-symbolic.md)-only processing without metabolization   
...
|:--------------------------|:-----------------------------------------------------|:-------------------------------------------------------------|
|      **Primary function** | Protects [True Self](true-self.md) from annihilation | Replaces idiomatic articulation with interchangeable fluency |
...
### Relations (Wiring)   
**Produced By:**   
- [PSB](protein-shake-brain-psb.md) (sustained / consolidated)   
- Failed topographic return   
- Basic-Assumption Dependency (BaD) — demanded by this ecology   
   
**Paralyzes:**   
- [Destiny Drive](destiny-drive.md) ([Bollas](christopher-bollas.md)) — the urge to articulate unique idiom is blocked   
- True Self emergence   
...
**Bypasses:**   
- [Alpha-Function](alpha-function.md) (no metabolization)   
- [Channel 1](channel-1-embodied-sensorimotor-pathway.md) (embodied verification)   
