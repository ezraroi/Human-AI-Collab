...
**Articulation = Alpha-Work entry point** (and can recruit [Alpha-Function](alpha-function.md)).   
...
Supporting methods: **[4Ps](4ps-protocol.md)**, **[Reflective Prompting](reflective-prompting.md)** (esp. Phase 2 discipline), [**Touch Grass Protocol**.](touch-grass-protocol.md)   
 --- 
## Cognitive Basis (RPD / Klein)   
IMM tracks expert decision patterns:   
- pattern recognition via [felt-sense](felt-sense.md) matching   
- serial evaluation (“test → revise” rather than output-shopping)   
- mental simulation ([As-If Body Loop](as-if-body-loop.md))   
