...
Links:
    ...
    - wilfred-bion.md
Emoji: "\U0001F4A1"
id: bafyreiahr7o5aggw43plm4qey2i2ofprrlu2dswcxf4hza6luaees2pq7y
---
# Reverie   
The term "**reverie**" refers to a state of mind, primarily of the mother or analyst ([the container](the-container.md)), that is essential for processing emotional experiences.   
Simply and shortly, reverie is:   
1. A state of **acute and receptive observation** or **preconscious dreamlike thinking**.   
2. The **capacity** of the container to **receive, metabolize, and transform** the infant's (or patient's) intolerable feelings ([beta-elements](beta-elements.md)) into a digestible, meaningful form ([alpha-elements](alpha-elements.md)).   
...
Connections to [Alpha-Function](alpha-function.md) :   
