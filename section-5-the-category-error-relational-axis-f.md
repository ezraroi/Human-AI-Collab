...
Earlier versions of the model conflated the Category Error with the cause of Protein Shake Brain ([PSB](protein-shake-brain-psb.md)).
...
but
PSB = [Channel 2](channel-2-symbolic.md)–only processing, not Category Error itself.   
